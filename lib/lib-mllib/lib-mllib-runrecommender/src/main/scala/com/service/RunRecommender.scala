...
object RunRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //val base = "D:\\workspace\\idea\\allenservice\\lib\\lib-mllib\\lib-mllib-runrecommender\\data\\"
    val base = "hdfs://datanode:9000/data/dwo/RunRecommender/"
    spark.sparkContext.setCheckpointDir(base)
